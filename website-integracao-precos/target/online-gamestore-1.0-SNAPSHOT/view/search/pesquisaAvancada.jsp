        ...
        <div class="card-body">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputGameName" aria-describedby="gameNameHelp" placeholder="Insira o nome do jogo">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="inputGameCompany" placeholder="Insira o nome da empresa">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="inputGameStore" placeholder="Insira o nome da Loja">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputGameGenre" aria-describedby="gameGenreHelp" placeholder="Insira o gênero do jogo">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="number" min="0.00" max="10000.00" step="0.01" class="form-control" id="inputMinimumPrice" placeholder="Insira o preço mínimo do jogo em reais.">
                    ...
                    <div class="col">
                        ...
                        <input type="number" min="0.00" max="10000.00" step="0.01" class="form-control" id="inputMaximumPrice" placeholder="Insira o preço máximo do jogo em reais.">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="number" min="0.00" max="10000.00" step="0.01" class="form-control" id="inputMinimumDiscount" placeholder="Insira o desconto mínimo do jogo em reais.">
                    ...
                    <div class="col">
                        ...
                        <input type="number" min="0.00" max="10000.00" step="0.01" class="form-control" id="inputMaximumDiscount" placeholder="Insira o desconto máximo do jogo em reais.">
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="inputIsFree">
