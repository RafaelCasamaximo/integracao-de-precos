...
function readUser(e) {
    ...
    $.get($(this).data('href'), function (data) {
        ...
        $modal.find('.p_idade').html('<strong>Idade: </strong>' + jogo.left.idade_requerida);
        $modal.find('.p_descricaoCurta').html('<strong>Descrição Curta: </strong>' + jogo.left.descricao_curta);
        $modal.find('.p_descricaoLonga').html('<strong>Descrição Longa: </strong>' + jogo.left.descricao_longa);
        ...
        $modal.find('.p_preco').html('<strong>Preço: </strong>' + jogo.right.preco_jogo);
    });
}
